...
const Navbar = () => {
  return (
    <div className="flex items-center justify-start gap-10 bg-[#2d2d2d] text-gray-300 text-sm h-8 px-2">
      {/* Left: Menu Items */}
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center bg-[#3c3c3c] rounded px-64 py-0.5">
