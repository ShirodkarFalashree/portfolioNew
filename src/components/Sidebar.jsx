...
const Sidebar = ({ onFileClick }) => {
  ...
  const handleFileClick = (file) => {
    ...
    if (window.innerWidth < 640) {
      setIsExplorerOpen(false); // close explorer on mobile
    }
  };

  return (
    <div className="flex h-screen font-mono relative">
      {/* Sidebar Icons */}
      <div className="flex flex-col items-center bg-[#2d2d2d] text-white py-4 w-12 space-y-6 justify-between">
        <button
      ...
      {/* Explorer */}
      {isExplorerOpen && (
        <div className="absolute sm:static left-12 top-0 z-50 sm:z-0">
